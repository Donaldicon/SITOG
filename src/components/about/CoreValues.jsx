  ...
  return (
    <section>
        ...
        className='relative mt-4 lg:mt-6 laptop:mt-8 big:mt-11 hidden md:block'>
            ...
            />
            <div 
            className='absolute top-1/2 -translate-y-1/2 w-full flex items-center justify-center p-10 space-x-[8px] lg:space-x-[10px] laptop:space-x-[15px] big:space-x-[20px]'>
                {/* box 1 */}
                <div 
                className='w-[27%] border-white/50 border-[3px] lg:border-[5px] laptop:border-[7px] big:border-[9px] p-[0.5%] rounded-md lg:rounded-lg laptop:rounded-xl big:rounded-2xl'>
                    <div 
